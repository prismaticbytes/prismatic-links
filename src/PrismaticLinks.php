    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'prismatic-links/default';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'prismatic-links/default/do-something';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = PrismaticLinksFieldField::class;
            }
        );
